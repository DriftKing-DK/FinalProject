...
public class IA_Create : MonoBehaviour
{
    ...
    public float init_damage = 10f;
    public float init_health = 50f;
    public float attack_distance = 2f;
    public float increase_health = 2f;
    ...
    void Start()
    {
        ...
        for (int i = 0; i < nbBots; i++){
            ...
            new_bot.Setup(increase_health, increase_attack, attack_distance, i, player);
            bot.Add(new_bot);
        }
    }
